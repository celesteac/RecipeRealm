...
## HTML Deliverable
- HTML Pages - there is a login page, a home page, and an add recipes page which connect to each other by links in the nav bar
...
- A thematic food image is displayed on the login screen
